...
class FlightRepository {
    ...
    List<Flight> findAll(SearchFlightCriteria criteria) {
        ...
        return flightRepositoryPort.findAll(criteria)
                .stream()
    ...
    private Flight convertFlightDTOToFlight(FlightDTO dto) {
        ...
        return flightFactory.createFlight(id, code, departurePlace, departureDateTime, arrivalPlace, arrivalDateTime, availableCapacity, price);
    }
