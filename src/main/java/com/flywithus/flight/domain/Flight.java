...
class Flight {
    ...
    Flight(FlightId id, Code code, Place departurePlace, DateTime departureDateTime, Place arrivalPlace, DateTime arrivalDateTime, Capacity availableCapacity, Money price) {
        this.id = id;
        this.code = code;
    ...
    SearchFlightDTO toSearchFlightDTO() {
        return new SearchFlightDTO(id.id(), code.code(), departurePlace.name(), departureDateTime.value(), arrivalPlace.name(), arrivalDateTime.value(), price.amount());
    }
