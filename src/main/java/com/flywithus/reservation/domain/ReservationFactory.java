...
class ReservationFactory {
    ...
    Reservation createReservation(ReservationId id, Client client, Flight flight, DateTime dateTime, NumberOfPeople numberOfPeople, Optional<Discount> discount, ReservationStatus status) {
        assertNotNull(id, "id");
        assertNotNull(client, "client");
        assertNotNull(flight, "flight");
