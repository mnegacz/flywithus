...
public class PaymentApplicationService
    implements RegisterPaymentPort, ReceivePaymentPort, ExpireNotReceivedPaymentsPort {
  ...
  public void receive(ReceivePaymentCommand command) {
    ...
    LOG.info(
        "Payment {} for reservation {} has been received.",
        payment.id(),
  ...
  public void expireNotReceivedPayments() {
    ...
    List<Payment> payments =
        paymentRepository.findAllNotReceivedPayments().stream()
  ...
  private void expirePayment(Payment payment, DateTime now) {
    ...
    LOG.info(
        "Payment {} for reservation {} has been expired.",
        payment.id(),
        payment.reservation().id());
  }
}
