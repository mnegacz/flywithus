...
public class ReservationStepDefinitions extends IntegrationTest {
    ...
    @Autowired
    private InMemoryReservationRepositoryAdapter inMemoryReservationRepositoryAdapter;

    @Autowired
    private InMemoryPaymentOperatorAdapter inMemoryPaymentOperatorAdapter;

    @Autowired
    private InMemoryFlightRepositoryAdapter inMemoryFlightRepositoryAdapter;

    @Autowired
    private InMemoryPaymentRepositoryAdapter inMemoryPaymentRepositoryAdapter;
    ...
    public void flightWithPriceIsProvided(String flightId, int price) {
        ...
        FlightDTO dto = new FlightDTO(flightId, CODE, DEPARTURE_PLACE, DEPARTURE_DATE_TIME, ARRIVAL_PLACE, ARRIVAL_DATE_TIME, AVAILABLE_CAPACITY, BigDecimal.valueOf(price));
    ...
    public void flightWithDepartureDate(String flightId, int days) {
        ...
        FlightDTO dto = new FlightDTO(flightId, CODE, DEPARTURE_PLACE, departureDateTime, ARRIVAL_PLACE, DEPARTURE_DATE_TIME, AVAILABLE_CAPACITY, PRICE);
        inMemoryFlightRepositoryAdapter.save(dto);
    }
    ...
    public void anotherFlightWithPriceIsProvided(String anotherFlightId) {
        ...
        FlightDTO dto = new FlightDTO(anotherFlightId, CODE, DEPARTURE_PLACE, DEPARTURE_DATE_TIME, ARRIVAL_PLACE, ARRIVAL_DATE_TIME, AVAILABLE_CAPACITY, PRICE);
        inMemoryFlightRepositoryAdapter.save(dto);
    }
    ...
    public void reservationIsProvided(String reservationId) {
        ...
        com.flywithus.reservation.dto.FlightDTO flightDTO = new com.flywithus.reservation.dto.FlightDTO(flightId, DEPARTURE_DATE_TIME, PRICE);

        ReservationDTO reservationDTO = new ReservationDTO(reservationId, clientDTO, flightDTO, NUMBER_OF_PEOPLE, NOW, ReservationStatusDTO.CREATED);
    ...
    public void clientChangesReservation() throws Exception {
        ChangeReservationCommand command = new ChangeReservationCommand(reservationId, anotherFlightId, NUMBER_OF_PEOPLE);
    ...
    public void clientCancelsReservation() throws Exception {
        ChangeReservationCommand command = new ChangeReservationCommand(reservationId, anotherFlightId, 1);
