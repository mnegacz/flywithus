...
public class PaymentStepDefinitons extends IntegrationTest {
    ...
    @Autowired
    private ExpirePaymentTask expirePaymentTask;
    ...
    public void flightIsProvided(String flightId) {
        ...
        FlightDTO dto = new FlightDTO(flightId, CODE, DEPARTURE_PLACE, DEPARTURE_DATE_TIME, ARRIVAL_PLACE, ARRIVAL_DATE_TIME, AVAILABLE_CAPACITY, PRICE);
    ...
    public void reservationFromTwoDaysIsProvided(String reservationId) {
        ...
        com.flywithus.reservation.dto.FlightDTO flightDTO = new com.flywithus.reservation.dto.FlightDTO(flightId, DEPARTURE_DATE_TIME, TEN);

        ReservationDTO reservationDTO = new ReservationDTO(reservationId, clientDTO, flightDTO, 1, twoDaysAgo, ReservationStatusDTO.CREATED);
    ...
    public void paymentForReservationIsProvided(String paymentId) {
        ...
        com.flywithus.payment.dto.ReservationDTO reservationDTO = new com.flywithus.payment.dto.ReservationDTO(reservationId, PRICE, NOW);
